                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            ...
                            <h3>
                                <NuxtLink to="/case-studies-details">Web development</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            ...
                            <h3>
                                <NuxtLink to="/case-studies-details">Smart vision</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <span>Marketing / Design</span>
                            <h3>
                                <NuxtLink to="/case-studies-details">Virtual reality</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <span>Ideas / Design</span>
                            <h3>
                                <NuxtLink to="/case-studies-details">Platform intergration</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <span>Marketing / Design</span>
                            <h3>
                                <NuxtLink to="/case-studies-details">Tech solutions</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <span>Ideas / Design</span>
                            <h3>
                                <NuxtLink to="/case-studies-details">Website design</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <span>Marketing / Design</span>
                            <h3>
                                <NuxtLink to="/case-studies-details">Platform intergation</NuxtLink>
                            </h3>
                        </div>
                    </div>
                </div>
